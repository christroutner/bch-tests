...
const RECV_ADDR = `bchtest:qzjwc0musf8vqp4nuau2t6fl099x6dgh2uspatyjvj`;
...
async function sendBch() {
  ...
  let remainder = originalAmount - satoshisToSend - satoshisPerByte*byteCount;
  ...
  let redeemScript;
  transactionBuilder.sign(0, keyPair, redeemScript, transactionBuilder.hashTypes.SIGHASH_ALL, satoshisToSend);
